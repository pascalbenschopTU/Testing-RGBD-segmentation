...
def plot_predictions_dual(dir_rgb, dir_rgbd, dir_dataset):
    ...
    # Load the target and prediction as numpy files
    for i in range(0, length_predictions, 2):
        ...
        pred_rgb_black = pred_rgb_black.squeeze()
        pred_rgb_depth = pred_rgb_depth.squeeze()
