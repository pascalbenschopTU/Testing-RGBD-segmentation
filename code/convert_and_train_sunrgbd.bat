...
@REM Train the model
python utils\train_clean.py --config=%config_path% --gpus 1 --checkpoint_dir %checkpoint_dir% --dataset_type %dataset_type% --num_hyperparameter_epochs 3 --x_channels=3 --x_e_channels=1
...
@REM Train the model
python utils\train_clean.py --config=%config_path% --gpus 1 --checkpoint_dir %checkpoint_dir% --dataset_type %dataset_type% --num_hyperparameter_epochs 3 --x_channels=3 --x_e_channels=3
...
python utils\create_predictions.py --model_a_path %rgb_model_weights% --model_b_path %rgb_depth_model_weights% --dir_dataset datasets\SUNRGBD --config=%config_path%
