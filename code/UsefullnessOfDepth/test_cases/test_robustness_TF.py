...
def train_models(log_file, args, config_location, dataset_name, model_file_names, max_train_images=500):
    ...
    if "rgbd_variation" in models_to_train:
        ...
        rgbd_variation_best_miou, rgbd_variation_model_weights_file = train_model_on_dataset(
            args=args,
            dataset_name=dataset_name,
            config_location=config_location,
            x_channels=3,
        ...
        model_files["rgbd_variation"] = rgbd_variation_model_weights_file
...
if __name__ == "__main__":
    ...
    model_file_names = ["rgbd", "rgbd_variation"]
    model_files = train_models(
        ...
        max_train_images=dataset_length,
    )
