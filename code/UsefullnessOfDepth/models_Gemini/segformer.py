...
class WeTr(nn.Module):
    def __init__(self, cfg, embedding_dim=256, pretrained=True, n_heads=8, drop_rate=0.0):
        super().__init__()
        ...
        if "swin" in backbone:
            ...
            ## initilize encoder
            state_dict = torch.load(self.config.pretrained_model)
